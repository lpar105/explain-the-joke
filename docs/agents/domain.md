...
If the concept you need isn't in the glossary yet, either you're inventing language the project doesn't use, or there's a real gap worth noting for `/grill-with-docs`.
